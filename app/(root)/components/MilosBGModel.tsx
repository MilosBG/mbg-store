        ...
        <div className="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5">
          {processSteps.map((step) => {
            ...
            return (
              <article
                key={step.number}
                className={`hoverEffect flex min-h-[220px] flex-col items-center justify-center border border-dashed px-5 py-7 text-center shadow-mbg-bx-shadow hover:-translate-y-1 hover:bg-mbg-white/80 hover:text-mbg-black ${step.className}`}
              >
                <Icon
                  aria-hidden="true"

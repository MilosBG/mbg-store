...
export const metadata: Metadata = {
  ...
  description: "A private Milos BG challenge and habit system built around GRIND, RESILIENCE, CONSISTENCY, FOCUS and ACHIEVE.",
...
export default async function GrindModePage({ searchParams }: Props) {
  ...
  return (
    <Container className="min-h-screen">
      <GrindModeClient lang={lang} bookUrl={bookUrl} ebookUrl={ebookUrl} />
    </Container>
  );
}

  ...
  >
    ...
    <ol className="space-y-1 text-xs text-mbg-darkgrey uppercase font-semibold leading-6">
      {tocItems[lang].map(([no, label, id]) => (
        <li key={id as string}>
          <a
            className={`hover:underline hover:text-mbg-lightgrey hoverEffect ${activeId === id ? "text-mbg-green" : ""}`}
            href={`#${id}`}
          >
...
const ContentEN: React.FC<{ allOpen: boolean | null }> = ({ allOpen }) => (
  <>
    ...
    >
      <p>
        We are Milos BG, an online boutique for handmade apparel and artisan
        goods, operating{" "}
        <a
          className="mbg-link"
    ...
    >
      <p>
        This policy covers data processing via our website, apps, emails,
        customer support and social pages. It applies to customers, prospects
        and visitors.
      </p>
    </Section>
    <Section
    ...
    >
      <ul className="list-disc space-y-1 pl-6">
        ...
        <li>
          <strong>Personal data</strong>: information relating to an identified
          or identifiable person.
        </li>
        <li>
          <strong>Processor</strong>: a provider processing data on our behalf.
        </li>
        <li>
          <strong>Cookie</strong>: a tracker stored on your device (incl. local
          storage, pixels, SDKs).
        </li>
      </ul>
    </Section>
    ...
    >
      <ul className="list-disc space-y-1 pl-6">
        ...
        <li>
          <strong>Account</strong>: login details, order history, preferences.
        </li>
        <li>
          <strong>Transaction</strong>: cart details, amount, payment status (we
        ...
        <li>
          <strong>Marketing</strong>: consents, email open/clicks, preferences.
        </li>
        <li>
          <strong>Social</strong>: interactions, comments, pseudonymized IDs.
        </li>
      </ul>
    </Section>
    <Section
      ...
      forceOpen={allOpen ?? undefined}
      title="6. Purposes & legal bases"
    >
      <p>We process data to:</p>
      <ul className="list-disc space-y-1 pl-6">
        <li>
          <strong>Sell & deliver</strong> products and manage the contract
          (performance of contract).
        </li>
        <li>
          <strong>Create & manage your account</strong>, history, returns,
          support (contract).
        </li>
        <li>
          <strong>Payment & anti‑fraud</strong> (legitimate interest / legal
          obligation).
        </li>
        <li>
          <strong>Service communications</strong> (legitimate interest /
          contract).
        </li>
        <li>
        ...
        <li>
          ...
          non‑essential cookies involved).
        </li>
        <li>
          <strong>Analytics</strong> essential/aggregated (legitimate interest);
          advanced (consent).
        </li>
        <li>
          <strong>Legal obligations</strong> (billing, accounting, authorities).
        </li>
      </ul>
    </Section>
    <Section
      ...
      forceOpen={allOpen ?? undefined}
      title="7. Cookies & trackers"
    >
      <p>
        A consent banner lets you accept/refuse non‑essential cookies per
        purpose (advanced analytics, advertising, personalization, social). You
        can change choices anytime via “Cookie settings”.
      </p>
      <p>
        Browser settings and Global Privacy Control (GPC) signals are honored
        where required by law.
      </p>
    </Section>
    <Section
      id="publicite-et-reseaux-sociaux"
      forceOpen={allOpen ?? undefined}
    ...
    <Section
      id="mesure-daudience-analytics"
      forceOpen={allOpen ?? undefined}
      title="9. Analytics & measurement"
    >
      <p>
        We measure site performance (page views, conversions, paths). Tools that
        set non‑essential trackers run only with your consent via the CMP.
      </p>
    </Section>
    <Section
      id="paiement-et-lutte-contre-la-fraude"
      forceOpen={allOpen ?? undefined}
      title="10. Payments & anti-fraud"
    >
      <p>
        Payments are handled by secure providers (e.g., PayPal). We never store
        card numbers. Anti-fraud checks may be performed (IP checks,
        inconsistencies, 3-D Secure).
      </p>
    </Section>
    <Section
      id="compte-client-et-service-client"
      forceOpen={allOpen ?? undefined}
      title="11. Account & customer support"
    >
      <p>
        Your account keeps order history, addresses, preferences. Support
        handles your requests and may access necessary info (order, logistics
        status, payments). Interactions may be logged.
      </p>
    </Section>
    <Section
      id="newsletters-sms"
    ...
    <Section
      id="personnalisation-et-profilage"
      forceOpen={allOpen ?? undefined}
      title="13. Personalization / profiling"
    >
      <p>
        We may tailor content/offers based on browsing and purchases. Where this
        relies on non‑essential trackers, we only do so with your consent. No
        profiling producing significant legal effects within the meaning of
        GDPR.
      </p>
    </Section>
    <Section
      id="partage-et-sous-traitants"
      forceOpen={allOpen ?? undefined}
      title="14. Sharing & processors"
    >
    ...
    >
      <p>
        Where data is transferred outside the EEA/UK, we implement appropriate
        safeguards (adequacy decisions, SCCs, supplementary measures). Copies
        available upon request.
      </p>
    </Section>
    <Section
      id="durees-de-conservation"
      forceOpen={allOpen ?? undefined}
      title="16. Retention periods"
    >
      <ul className="list-disc space-y-1 pl-6">
        <li>
          <strong>Inactive account</strong>: 3 years after last activity, then
          deletion/anonymization.
        </li>
        <li>
          <strong>Orders/invoices</strong>: 10 years (accounting) in secure
          archive.
        </li>
        <li>
        ...
        <li>
          <strong>Customer support</strong>: 3 years from last relevant
          interaction.
        </li>
        <li>
          <strong>Anti‑fraud / security</strong>: 6 months to 2 years as
          necessary.
        </li>
        <li>
          <strong>Cookies</strong>: per Annex A.
        </li>
      </ul>
    </Section>
    <Section
    ...
    >
      <p>
        We apply appropriate technical and organizational measures: in‑transit
        encryption, access control, logging, backups, environment separation,
        periodic security tests, permissions and incident management.
      </p>
    </Section>
    <Section
      id="vos-droits"
    ...
    <Section id="mineurs" forceOpen={allOpen ?? undefined} title="19. Minors">
      <p>
        Our site is not intended for children under 15. We do not knowingly
        collect their data. Parents/guardians may contact us for deletion.
      </p>
    </Section>
    <Section
      id="signals-consent-gpc"
      forceOpen={allOpen ?? undefined}
      title="20. Consent & Global Privacy Control (GPC)"
    >
      <p>
        If GPC is enabled in your browser, we treat it as an opt‑out of ad
        trackers where required by law. You can also manage choices via our
        cookie banner.
      </p>
    </Section>
    <Section
      ...
      forceOpen={allOpen ?? undefined}
      title="21. Exercising your rights"
    >
      <p>
        Use the{" "}
        <Link className="mbg-link" href={`mailto:${PRIVACY_INFO.email}`}>
    ...
    <Section
      id="mises-a-jour"
      forceOpen={allOpen ?? undefined}
      title="22. Updates to this policy"
    >
      <p>
        We may update this policy to reflect legal changes and our practices.
        The last update date appears below. For material changes we will notify
        you by email or site notice.
      </p>
    </Section>
    <Section
      id="annexe-cookies"
    ...
    >
      <ul className="list-disc space-y-2 pl-6">
        ...
        <li><strong>Prestataire email</strong> — {PRIVACY_INFO.emailProvider}.</li>
        <li><strong>Transport / logistique</strong> — {PRIVACY_INFO.carrier}.</li>
      </ul>
      <p className="text-[11px] text-mbg-darkgrey">
...
const ContentFR: React.FC<{ allOpen: boolean | null }> = ({ allOpen }) => (
  <>
    ...
    >
      <p>
        Nous sommes Milos BG, boutique en ligne d’articles artisanaux et
        vêtements faits main. Nous exploitons le site{" "}
        <a
          className="mbg-link"
          href="https://www.milos-bg.com"
          target="_blank"
    ...
    <Section
      id="portee"
      forceOpen={allOpen ?? undefined}
      title="2. Portée de cette politique"
    >
      <p>
        Cette politique s’applique aux traitements de données effectués via
        notre site, nos applications éventuelles, nos emails, notre service
        client et nos pages sociales. Elle couvre les clients, les prospects et
        les visiteurs.
      </p>
    </Section>
    ...
    >
      <ul className="list-disc space-y-1 pl-6">
        <li>
          <strong>RGPD</strong> : Règlement (UE) 2016/679.
        </li>
        <li>
          <strong>Donnée personnelle</strong> : information relative à une
          personne identifiée ou identifiable.
        </li>
        <li>
          <strong>Sous‑traitant</strong> : prestataire traitant des données pour
          notre compte.
        </li>
        <li>
          <strong>Cookie</strong> : traceur stocké sur votre appareil (incluant
          local storage, pixels et SDK).
        </li>
      </ul>
    </Section>
    ...
    <Section
      id="responsable-du-traitement"
      forceOpen={allOpen ?? undefined}
      title="4. Responsable du traitement"
    >
      <p>
    ...
    >
      <ul className="list-disc space-y-1 pl-6">
        ...
        <li>
          <strong>Compte</strong> : identifiants, historique de commandes,
          préférences.
        </li>
        <li>
          <strong>Transaction</strong> : détail panier, montant, statut de
        ...
        <li>
          <strong>Marketing</strong> : consentements, ouverture/clic emails,
          préférences.
        </li>
        <li>
          <strong>Réseaux sociaux</strong> : interactions, commentaires,
    ...
    <Section
      id="finalites-et-bases-legales"
      forceOpen={allOpen ?? undefined}
      title="6. Finalités & bases légales"
    >
      <p>Nous traitons vos données pour :</p>
      <ul className="list-disc space-y-1 pl-6">
        <li>
          <strong>Vendre et livrer</strong> nos produits, gérer la relation
          contractuelle (exécution du contrat).
        </li>
        <li>
          <strong>Créer et gérer le compte</strong>, historique, retours, SAV
          (exécution du contrat).
        </li>
        <li>
          <strong>Paiement & anti‑fraude</strong> (intérêt légitime / obligation
          légale).
        </li>
        <li>
          <strong>Communications de service</strong> (intérêt légitime /
          exécution du contrat).
        </li>
        <li>
        ...
        <li>
          ...
          (consentement si via cookies non essentiels).
        </li>
        <li>
          <strong>Mesure d’audience</strong> essentielle et agrégée (intérêt
          légitime) ; avancée (consentement).
        </li>
        <li>
          <strong>Respect des obligations légales</strong> (facturation,
          comptabilité, demandes autorités).
        </li>
      </ul>
    </Section>
    ...
    >
      <p>
        Un bandeau de consentement vous permet d’accepter/refuser les cookies
        non essentiels par finalité (analytics avancée, publicité,
        personnalisation, réseaux sociaux). Vous pouvez modifier vos choix à
        tout moment via « Paramètres cookies » en bas de page.
      </p>
      <p>
        Les paramètres de votre navigateur et le signal Global Privacy Control
        (GPC) sont pris en compte lorsque requis par la loi.
      </p>
    </Section>
    ...
    <Section
      id="mesure-daudience-analytics"
      forceOpen={allOpen ?? undefined}
      title="9. Mesure d’audience (Analytics)"
    >
      <p>
        Nous mesurons les performances du site (pages vues, conversions,
        parcours). Lorsque des outils déposent des traceurs non strictement
        nécessaires, ils ne sont activés qu’avec votre consentement via le CMP.
      </p>
    </Section>
    ...
    <Section
      id="paiement-et-lutte-contre-la-fraude"
      forceOpen={allOpen ?? undefined}
      title="10. Paiement & anti‑fraude"
    >
      <p>
        Le paiement est confié à des prestataires sécurisés (ex. PayPal). Nous
        ne stockons jamais vos numéros de carte. Des contrôles anti-fraude
        peuvent être réalisés (vérification IP, incohérences, 3-D Secure).
      </p>
    </Section>
    ...
    <Section
      id="compte-client-et-service-client"
      forceOpen={allOpen ?? undefined}
      title="11. Compte client & service client"
    >
      <p>
        Votre compte conserve l’historique de commandes, adresses, préférences.
        Le service client traite vos demandes et peut accéder aux informations
        nécessaires à la résolution (commande, statut logistique, paiements).
        Les échanges peuvent être historisés.
      </p>
    </Section>
    ...
    <Section
      id="personnalisation-et-profilage"
      forceOpen={allOpen ?? undefined}
      title="13. Personnalisation / profilage"
    >
      <p>
        Nous pouvons adapter les contenus/offres selon votre navigation et vos
        achats. Lorsque cela repose sur des traceurs non essentiels, nous le
        faisons uniquement avec votre consentement. Aucun profilage produisant
        des effets juridiques significatifs au sens du RGPD n’est effectué.
      </p>
    </Section>
    ...
    <Section
      id="partage-et-sous-traitants"
      forceOpen={allOpen ?? undefined}
      title="14. Partage & sous‑traitants"
    >
      <p>
        Nous partageons des données uniquement avec des catégories de
        destinataires autorisés :
      </p>
      <ul className="list-disc space-y-1 pl-6">
        <li>Prestataires de paiement et de prévention de fraude ;</li>
        <li>
          Logisticiens, imprimeurs/ateliers pour fabrication sur‑mesure et
          livraison ;
        </li>
    ...
    >
      <p>
        Si des données sont transférées hors EEE/Royaume‑Uni, nous mettons en
        place des garanties appropriées (décisions d’adéquation, Clauses
        Contractuelles Types, mesures supplémentaires). Vous pouvez obtenir
        copie des garanties sur demande.
      </p>
    </Section>
    ...
    >
      <ul className="list-disc space-y-1 pl-6">
        <li>
          <strong>Compte client inactif</strong> : 3 ans après la dernière
          activité, puis suppression/anonymisation.
        </li>
        <li>
          <strong>Commandes/factures</strong> : 10 ans (obligation comptable) en
          archivage sécurisé.
        </li>
        <li>
        ...
        <li>
          <strong>Service client</strong> : 3 ans à compter de la dernière
          interaction pertinente.
        </li>
        <li>
          <strong>Anti‑fraude / sécurité</strong> : 6 mois à 2 ans selon
          nécessité.
        </li>
        <li>
          <strong>Cookies</strong> : durée selon l’Annexe A.
        </li>
      </ul>
    </Section>
    ...
    >
      <p>
        ...
        chiffrement en transit, contrôle d’accès, journalisation, sauvegardes,
        cloisonnement des environnements, tests de sécurité périodiques, gestion
        des habilitations et des incidents.
      </p>
    </Section>
    ...
    <Section id="mineurs" forceOpen={allOpen ?? undefined} title="19. Mineurs">
      <p>
        Notre site n’est pas destiné aux enfants de moins de 15 ans. Nous ne
        collectons pas sciemment leurs données. Les parents/tuteurs peuvent nous
        contacter pour suppression.
      </p>
    </Section>
    ...
    <Section
      id="signals-consent-gpc"
      forceOpen={allOpen ?? undefined}
      title="20. Consentement & Global Privacy Control (GPC)"
    >
      <p>
        Si GPC est activé dans votre navigateur, nous le traitons comme une
        opposition/opt‑out aux traceurs publicitaires lorsque la loi l’impose.
        Vous pouvez aussi paramétrer vos choix via notre bannière cookies.
      </p>
    </Section>
    ...
    <Section
      id="mises-a-jour"
      forceOpen={allOpen ?? undefined}
      title="22. Mises à jour de cette politique"
    >
      <p>
        Nous pouvons modifier cette politique pour refléter les évolutions
        légales et nos pratiques. La date de dernière mise à jour figure
        ci‑dessous. En cas de changements substantiels, nous vous en informerons
        par email ou via un avis sur le site.
      </p>
    </Section>
  ...
  const ui = useMemo(
    () => ({
      ...
      intro:
        lang === "fr" ? (
          <>
            Cette politique décrit comment nous collectons, utilisons,
            partageons et protégeons vos données personnelles lorsque vous
            visitez notre site, créez un compte, passez commande ou interagissez
            avec nous.
          </>
        ) : (
          <>
            This policy explains how we collect, use, share and protect your
            personal data when you visit our site, create an account, place
            orders or interact with us.
          </>
        ),
      subIntro:
        lang === "fr" ? (

  ...
  <div className="mx-auto max-w-5xl py-12 md:py-16">
    <div className="max-w-3xl">
      ...
      <p className="mt-4 text-base leading-8 text-mbg-black/80 md:text-lg">
        Milos BG was never meant to be only about clothing. The brand is built
        around a philosophy of continuous improvement — the belief that
        achievement is not a single moment, but the result of what we
    ...
    <div className="mx-auto max-w-5xl">
      <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
        ...
        <p className="max-w-md text-xs leading-6 text-mbg-darkgrey md:text-right">
          Like the chapters of a book, each step builds upon the one before it.
          Not simply meant to be read — but lived.
        </p>
      </div>
    ...
    <div className="relative overflow-hidden bg-mbg-black px-6 py-12 md:px-12 md:py-16">
      ...
      <div className="relative z-10 max-w-3xl">
        ...
        <h3 className="mt-5 text-4xl font-bold uppercase leading-[0.95] tracking-[-0.04em] text-mbg-white sm:text-5xl md:text-7xl">
          Grind Until
          <br />
          <span className="text-mbg-green">You Achieve.</span>
        </h3>

        <p className="mt-7 max-w-xl text-xs leading-6 text-mbg-white/60 md:text-sm">
          Once the mentality becomes part of who you are, you don&apos;t simply
          believe in it — you wear it.
        </p>
      </div>
    </div>
  </div>
    ...
    <div className="grid gap-10 md:grid-cols-2 md:gap-16">
      ...
      <div className="space-y-6 text-[13px] leading-7 text-mbg-darkgrey">
        ...
        <p>
          ...
          <strong className="font-semibold text-mbg-black">
            {" "}
            keep working, keep learning, keep improving, keep moving forward.
          </strong>
        </p>
      ...
      <div className="grid gap-10 md:grid-cols-[1fr_1.2fr] md:items-center">
        <div>
          ...
          <p className="mt-4 max-w-md text-base leading-8 text-mbg-black md:text-lg">
            ACHIEVE means very little without everything required to reach it.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-0 border-t border-mbg-black/10 sm:grid-cols-3">
          {[
            ...
            <div
              key={item}
              className="border-b border-mbg-black/10 py-4"
            >
